...
def vector_operations(db={}):
    display.clear_display()
    json_file = "/database/vector_operations_app_list.json" 
    ...
    for app in data:
        if app["visibility"]:
            vector_operations_list.append(app["name"])

    vector_operations_list.sort()

    menu.menu_list=vector_operations_list
    menu.update()
    ...
    try:
        while True:
            ...
            if inp_menu == "back":
                ...
                current_app[1] = "vector_operations"
                break
